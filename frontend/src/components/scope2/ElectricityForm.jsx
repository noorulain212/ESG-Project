...
export default function ElectricityForm() {
  const providers = ["Grid", "Independent Supplier", "Other"];
  ...
  // Zustand store (Electricity ONLY)
  ...
  const filteredEntries = electricityEntries.filter(
    (e) =>
      ...
      e.certificate.toLowerCase().includes(search.toLowerCase())
  );
    ...
    <div className="electricity-form">
      ...
      <div className="form-header">
        ...
        <p className="header-description">
          Record your purchased electricity consumption and renewable energy certificates
        </p>
      </div>
      ...
      <div className="search-wrapper">
        ...
        <input
          type="text"
          placeholder="Search by provider or certificate..."
          value={search}
      ...
      <div className="input-section">
        <div className="input-grid">
          <div className="input-group">
            <label className="input-label">Electricity Provider</label>
            <SelectDropdown
              value={provider}
          ...
          <div className="input-group">
            <label className="input-label">RES Certificate</label>
            <input
              type="text"
              value={certificate}
                  ...
                  <tr key={e.id}>
                    <td>
                      <div className="provider-cell">
                        <span className="provider-badge">{e.provider}</span>
                      </div>
                    </td>
                    <td>
                      <span className="consumption-value">{e.kwh.toLocaleString()}</span>
                      <span className="consumption-unit"> kWh</span>
                    </td>
                    <td>
                      {e.certificate ? (
                        <span className="certificate-badge">{e.certificate}</span>
                      ) : (
      ...
      <style jsx>{`
        ...
        .provider-select :global(select:hover) {
          border-color: #2E7D32;
        }

        .provider-select :global(select:focus) {
          border-color: #2E7D32;
          box-shadow: 0 0 0 3px rgba(46, 125, 50, 0.1);
        }
