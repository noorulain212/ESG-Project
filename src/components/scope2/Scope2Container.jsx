...
export default function Scope2Container() {
  const [activeTab, setActiveTab] = useState("electricity"); // Set to first tab ID by default
  const [calculationMethod, setCalculationMethod] = useState("UK Government Factors");

  const scope2Tabs = [
    { id: "electricity", label: "Purchased Electricity", icon: "⚡" },
    { id: "heating", label: "Purchased Heat/Cooling", icon: "🔥" },
    { id: "renewables", label: "Renewables", icon: "🌱" },
  ];

  return (
    <div className="scope2-container">
      {/* Header - Matching Scope1 Design */}
      ...
      {/* Method Selection Bar - Matching Scope1 */}
      ...
      {/* Professional Tabs - Matching Scope1 Style */}
      ...
      <div className="tab-content-wrapper">
        <div className={`tab-pane ${activeTab === 'electricity' ? 'active' : ''}`}>
          <ElectricityForm />
        </div>
        <div className={`tab-pane ${activeTab === 'heating' ? 'active' : ''}`}>
          <HeatingForm />
        </div>
        <div className={`tab-pane ${activeTab === 'renewables' ? 'active' : ''}`}>
          <RenewableForm />
        </div>
      </div>

      {/* Summary - Matching Scope1 */}
      <Scope2Summary />
      ...
      <style jsx>{`
        ...
        /* Header Styles - Exact match with Scope1 */
        .calculator-header {
        ...
        /* Method Bar - Exact match with Scope1 */
        .method-bar {
          background: white;
          border-radius: 16px;
          padding: 16px 24px;
        ...
        /* Professional Tabs Styling - Matching Scope1 */
        .tabs-container {
          margin-bottom: 24px;
          background: white;
          border-radius: 20px;
